...
async function render() {
  ...
  containerRef.innerHTML = `
    ...
    <div class="card">
      ...
      <p class="muted" style="margin:-6px 0 0;">Utilisée pour estimer l'heure d'arrivée à chaque arrêt (trajets majorés de 10 %), et pour vérifier les heures limites ci-dessus.</p>
    </div>
    <div class="card">
